...
public class StudentServiceServiceLocator extends org.apache.axis.client.Service implements com.lavanya.gudimella.service.StudentServiceService {
    ...
    private java.lang.String StudentService_address = "http://localhost:8080/HibernateConfiguration/services/StudentService";
    ...
    public com.lavanya.gudimella.service.StudentService getStudentService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lavanya.gudimella.service.StudentServiceSoapBindingStub _stub = new com.lavanya.gudimella.service.StudentServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lavanya.gudimella.service.StudentService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lavanya.gudimella.service.StudentServiceSoapBindingStub _stub = new com.lavanya.gudimella.service.StudentServiceSoapBindingStub(new java.net.URL(StudentService_address), this);
                _stub.setPortName(getStudentServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.gudimella.lavanya.com", "StudentServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.gudimella.lavanya.com", "StudentService"));
        }
